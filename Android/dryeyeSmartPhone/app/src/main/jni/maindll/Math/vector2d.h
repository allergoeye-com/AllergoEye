...
struct Vector2D {
    ...
    Vector2D &operator=(const Vector2F &p)
    {
        x = p.x;
        y = p.y;
        return *this;
    ...
    Vector2D &operator=(const POINT &p)
    {
        x = p.x;
        y = p.y;
        return *this;
    ...
    { return fabs(x - p.x) < PRECISION && fabs(y - p.y) < PRECISION; }
    ...
    {
        double l = Len();
        return l ? Vector2D(x / l, y / l) : Vector2D(0, 0);
    }
...
//
//------------------------------------
inline double operator*(const Vector2D &p, const Vector2D &p1)
{ return p.x * p1.x + p.y * p1.y; }

//------------------------------------
//
//------------------------------------
inline Vector2D operator+(const Vector2D &p, const Vector2D &p1)
{ return Vector2D(p.x + p1.x, p.y + p1.y); }
...
//
//------------------------------------
inline Vector2D operator*(double i, const Vector2D &p)
{ return Vector2D(p.x * i, p.y * i); }
...
//------------------------------------
inline double
PolarAngle(const Vector2D &p1, const Vector2D &p2, const Vector2D &p3, const Vector2D &p4)
{
