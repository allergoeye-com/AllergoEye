...
void ArRBMap<MAP_VALUE, MAP_KEY, CMP, ARR_KEY, ARR_TREE>::GetSortedRBData(
...
template<class MAP_VALUE, class MAP_KEY, class CMP, class ARR_KEY, class ARR_TREE>
bool ArRBMap<MAP_VALUE, MAP_KEY, CMP, ARR_KEY, ARR_TREE>::Insert(MAP_KEY &key, MAP_VALUE *value,
                                                                 DINT *node)
{
...
template<class MAP_VALUE, class MAP_KEY, class CMP, class ARR_KEY, class ARR_TREE>
MAP_VALUE &ArRBMap<MAP_VALUE, MAP_KEY, CMP, ARR_KEY, ARR_TREE>::Add(MAP_KEY &key, MAP_VALUE *value,
                                                                    DINT *_node)
{
