...
import static com.allergoscope.app.wifi.SyncThread.ReadMdnsRecords;
import static com.allergoscope.app.wifi.MdnsUtils.MDNSIsRun;
import static com.allergoscope.app.wifi.MdnsUtils.StopMDNS;
...
public class MDNSServerClient extends Thread implements Closeable {
    ...
    private String mdnsPatern = "com.allergoscope.app";
    private String mdnsName = "com.allergoscope.client";
