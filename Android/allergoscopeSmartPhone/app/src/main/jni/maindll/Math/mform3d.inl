...
{
    return Vector3D(
            form.M.m11ScaleX * p.x + form.M.m12ShiftX * p.y + form.M.m13Shift * p.z + form.M.m14Dx,
...
//------------------------------------
inline void
MFORM3D::Ortho(double left, double top, double right, double bottom, double Near, double Far)
{
    MFORM3D m;
...
//------------------------------------
inline void
MFORM3D::Frustrum(double left, double top, double right, double bottom, double dbNear, double dbFar)
{
    MFORM3D m;
...
//------------------------------------
inline void
MFORM3D::Perspective(double angle, double width, double height, double dbNear, double dbFar)
{
