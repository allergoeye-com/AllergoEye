...
public:
	...
	~FFileINI() {}
	bool WriteString(TString Section, TString Entry, const char *lpszValue);
	int GetInt(TString Section, TString Entry, int iDefault = 0);
	int GetIntHex(TString Section, TString Entry, int iDefault = 0);
	bool WriteIntHex(TString Section, TString Entry, int iValue);
	bool WriteInt(TString Section, TString Entry, int iValue);
	double GetDouble(TString Section, TString Entry, double fDefault = 0.0); 
	bool WriteDouble(TString Section, TString Entry, double fValue);
	void SectionNames(MVector<TString> &);
	void DeleteSection(TString Section);
	bool GetSectionEntry(TString Section, _RBMapSimple(TString, TString) &sec);
